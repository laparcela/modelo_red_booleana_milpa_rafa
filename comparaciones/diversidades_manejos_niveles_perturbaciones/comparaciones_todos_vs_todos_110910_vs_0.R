...
pdf(paste0("~/Dropbox/Chido/comparaciones/diversidades_manejos_niveles_perturbaciones/diversidad_vs_diversidad_119010_",perturbacion[h],".pdf",height=10, width=16))
myImagePlot(matrizMZ,paste0("Comparaciones múltiples de la permanencia promedio del maíz\n",perturbaciones.main[h]", Nivel de pert: 0.1",manejo="otro")
#myImagePlot(matrizFR,"Comparaciones múltiples de la permanencia promedio del frijol\n Todas las perturbaciones, nivel=1/10, control determinista",manejo="otro")
