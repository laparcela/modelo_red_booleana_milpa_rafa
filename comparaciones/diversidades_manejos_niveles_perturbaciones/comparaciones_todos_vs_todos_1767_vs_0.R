...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_niveles_perturbaciones/todos_vs_todos_1767_vs_0.pdf",height=10, width=16)
myImagePlot(matrizMZ,"Comparaciones múltiples de la permanencia promedio del maíz\n Todas las perturbaciones, nivel=1/7, control determinista",manejo="otro")
...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_niveles_perturbaciones/sentido_vs_sentido_1767_vs_0.pdf",height=10, width=16)
