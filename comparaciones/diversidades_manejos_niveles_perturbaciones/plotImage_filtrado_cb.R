...
#axis(BELOW<-1, at=1:length(xLabels), labels=xLabels, cex.axis=0.7)
 axis(LEFT <-3, at=c(0.5,8.5,16.5,24.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=3)
 axis(LEFT <-3, at=c(4,12,20), labels=c("milpa","mzcb","cb" ), las= HORIZONTAL<-1, cex.axis=0.9, line=3,tick=F)

 axis(LEFT <-3, at=seq(0.5,24.5,4), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-3, at=seq(2.5, 22.5,4), labels=rep(c("Desyerbe", "Desyerbe \nPlaguicida"),3), las= HORIZONTAL<-1, cex.axis=0.75,tick=F)

 axis(LEFT <-2, at=c(0.5,8.5,16.5,24.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=5.5)
 axis(LEFT <-2, at=c(4,12,20), labels=c( "cb", "mzcb","milpa" ), las= HORIZONTAL<-1, cex.axis=0.9, line=5.5,tick=F)

 axis(LEFT <-2, at=seq(0.5,24.5,4), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-2, at=seq(2.5, 22.5,4), labels=rep(c("Desyerbe \nPlaguicida", "Desyerbe" ),3), las= HORIZONTAL<-1, cex.axis=0.85,tick=F)
