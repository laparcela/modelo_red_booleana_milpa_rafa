...
#axis(BELOW<-1, at=1:length(xLabels), labels=xLabels, cex.axis=0.7)
 ...
 cex.axis=0.7,line=3)
 axis(LEFT <-3, at=c(10,30,50,70,90), labels=c("milpa","mzfre","mzcb", "mz","cb" ), las= HORIZONTAL<-1, cex.axis=0.9, line=3,tick=F)
 ...
 axis(LEFT <-2, at=c(10,30,50,70,90), labels=c( "mzfre","milpa","mz", "cb", "mzcb" ), las= HORIZONTAL<-1, cex.axis=0.9, line=5.5,tick=F)
