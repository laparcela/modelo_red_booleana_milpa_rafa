...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/todos_vs_todos_herbívoros.pdf",height=10, width=16)
...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/sentido_vs_sentido_herbívoros.pdf",height=10, width=16)
source("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/plotImage_filtrado_mz.R")
myImagePlot(matrizMZ,"Comparaciones múltiples de la permanencia promedio del maíz \n Perturbando a los herbívoros, todos los niveles, control determinista",manejo="otro")
