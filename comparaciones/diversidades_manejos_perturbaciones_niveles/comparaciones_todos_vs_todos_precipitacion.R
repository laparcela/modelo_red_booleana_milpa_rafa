...
#"det","precipitacion","arvenses","herbivoros")
#manejo=c("desyer")
...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/todos_vs_todos_precipitacion.pdf",height=10, width=16)
...
pdf("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/sentido_vs_sentido_precipitacion.pdf",height=10, width=16)
source("~/Dropbox/Chido/comparaciones/diversidades_manejos_perturbaciones_niveles/plotImage_filtrado_mz.R")
myImagePlot(matrizMZ,"Comparaciones múltiples de la permanencia promedio del maíz \n Perturbando la precipitación, todos los niveles, control determinista",manejo="otro")
