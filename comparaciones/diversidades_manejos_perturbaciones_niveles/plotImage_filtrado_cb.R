...
#axis(BELOW<-1, at=1:length(xLabels), labels=xLabels, cex.axis=0.7)
 axis(LEFT <-3, at=c(0.5,10.5,20.5,30.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=3)
 axis(LEFT <-3, at=c(5.5,15.5,25.5), labels=c("milpa","mzcb","cb" ), las= HORIZONTAL<-1, cex.axis=0.9, line=3,tick=F)

 axis(LEFT <-3, at=seq(0.5,30.5,5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-3, at=seq(3, 28,5), labels=rep(c("Desyerbe", "Desyerbe \nPlaguicida"),3), las= HORIZONTAL<-1, cex.axis=0.75,tick=F)

 axis(LEFT <-2, at=c(0.5,10.5,20.5,30.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=5.5)
 axis(LEFT <-2, at=c(4.5,14.5,24.5), labels=c( "cb", "mzcb","milpa" ), las= HORIZONTAL<-1, cex.axis=0.9, line=5.5,tick=F)

 axis(LEFT <-2, at=seq(0.5,30.5,5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-2, at=seq(3, 28,5), labels=rep(c("Desyerbe \nPlaguicida", "Desyerbe" ),3), las= HORIZONTAL<-1, cex.axis=0.85,tick=F)
