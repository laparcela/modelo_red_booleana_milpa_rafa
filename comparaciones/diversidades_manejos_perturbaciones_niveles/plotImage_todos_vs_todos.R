...
#axis(BELOW<-1, at=1:length(xLabels), labels=xLabels, cex.axis=0.7)
 axis(LEFT <-3, at=c(0.5,25.5,50.5,75.5,100.5,125.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=3)
 axis(LEFT <-3, at=c(12.5,37.5,62.5,87.5,112.5), labels=c("milpa", "mzcb", "mzfre", "mz","cb" ), las= HORIZONTAL<-1, cex.axis=0.9, line=3,tick=F)

 axis(LEFT <-3, at=seq(0.5,125.5,5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-3, at=seq(3, 123,5), labels=rep(c("Desyerbe", "Desyerbe \nPlaguicida", "Herbicida",  "Plaguicida \nHerbicida", "Roundup" ),5), las= HORIZONTAL<-1, cex.axis=0.75,tick=F)

 axis(LEFT <-2, at=c(0.5,25.5,50.5,75.5,100.5,125.5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7,line=5.5)
 axis(LEFT <-2, at=c(12.5,37.5,62.5,87.5,112.5), labels=c("cb", "mz", "mzfre", "mzcb","milpa" ), las= HORIZONTAL<-1, cex.axis=0.9, line=5.5,tick=F)

 axis(LEFT <-2, at=seq(0.5,125.5,5), labels=F, las= HORIZONTAL<-1,
 cex.axis=0.7)
 axis(LEFT <-2, at=seq(3, 123,5), labels=rep(c("Roundup", "Plaguicida \nHerbicida", "Herbicida", "Desyerbe \nPlaguicida", "Desyerbe" ),5), las= HORIZONTAL<-1, cex.axis=0.85,tick=F)
