source("~/Dropbox/Chido/comparaciones/resultados/plotImage_todos_vs_todos(copia).R")
...
pdf(paste0("~/Dropbox/Chido/comparaciones/resultados/mz_diversidad_vs_diversidad_119010.pdf"),height=7,width=10)
par(mfrow=c(2,2))
...
#								print(b)
								if(b!="NaN" & a[[h]][[i]][[j]][[level]]$MzG_MzJ[2]!=0 & a[[h]][[m]][[n]][[level]]$MzG_MzJ[2]!=0){
									if(b>zeta | b<(-zeta)){
										matrizMZ[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-a[[h]][[i]][[j]][[level]]$MzG_MzJ[1]-a[[h]][[m]][[n]][[level]]$MzG_MzJ[1]
									}else{
...
dev.off()
pdf(paste0("~/Dropbox/Chido/comparaciones/resultados/fre_diversidad_vs_diversidad_119010.pdf"),height=7,width=10)
for(h in 1:length(perturbacion)){
	for(i in 1:length(manejo)){
		for(j in 1:length(diversidad)){
			if(h==1) {nivel=c("0"); level=1}
...
#								print(b)
								if(b!="NaN" & a[[h]][[i]][[j]][[level]]$FreG_Fre[2]!=0 & a[[h]][[m]][[n]][[level]]$FreG_Fre[2]!=0){
									if(b>zeta | b<(-zeta)){
										matrizFR[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-a[[h]][[i]][[j]][[level]]$FreG_Fre[1]-a[[h]][[m]][[n]][[level]]$FreG_Fre[1]
									}else{
										matrizFR[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-0
									}
								}else{
										matrizFR[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-0
								}
...
dev.off()
pdf(paste0("~/Dropbox/Chido/comparaciones/resultados/cb_diversidad_vs_diversidad_119010.pdf"),height=7,width=10)
for(h in 1:length(perturbacion)){
	for(i in 1:length(manejo)){
		for(j in 1:length(diversidad)){
			if(h==1) {nivel=c("0"); level=1}
...
#								print(b)
								if(b!="NaN" & a[[h]][[i]][[j]][[level]]$CbG_CbJ[2]!=0 & a[[h]][[m]][[n]][[level]]$CbG_CbJ[2]!=0){
									if(b>zeta | b<(-zeta)){
										matrizCB[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-a[[h]][[i]][[j]][[level]]$CbG_CbJ[1]-a[[h]][[m]][[n]][[level]]$CbG_CbJ[1]
									}else{
...
dev.off()
pdf(paste0("~/Dropbox/Chido/comparaciones/resultados/quel_diversidad_vs_diversidad_119010.pdf"),height=7,width=10)
for(h in 1:length(perturbacion)){
	for(i in 1:length(manejo)){
		for(j in 1:length(diversidad)){
			if(h==1) {nivel=c("0"); level=1}
...
#								print(b)
								if(b!="NaN" & a[[h]][[i]][[j]][[level]]$Quelites[2]!=0 & a[[h]][[m]][[n]][[level]]$Quelites[2]!=0){
									if(b>zeta | b<(-zeta)){
										matrizQ[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-a[[h]][[i]][[j]][[level]]$Quelites[1]-a[[h]][[m]][[n]][[level]]$Quelites[1]
									}else{
...
dev.off()
pdf(paste0("~/Dropbox/Chido/comparaciones/resultados/conj_diversidad_vs_diversidad_119010.pdf"),height=7,width=10)
for(h in 1:length(perturbacion)){
	for(i in 1:length(manejo)){
		for(j in 1:length(diversidad)){
			if(h==1) {nivel=c("0"); level=1}
...
#								print(b)
								if(b!="NaN" & a[[h]][[i]][[j]][[level]]$conj[2]!=0 & a[[h]][[m]][[n]][[level]]$conj[2]!=0){
									if(b>zeta | b<(-zeta)){
										matrizSH[length(diversidad)*(i-1)+j, length(diversidad)*(m-1)+n]<-a[[h]][[i]][[j]][[level]]$conj[1]-a[[h]][[m]][[n]][[level]]$conj[1]
									}else{
