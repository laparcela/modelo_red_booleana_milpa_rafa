...
sequia<-genera_db(df,"Sequía", "Riesgo_relativo")
arvenses<-genera_db(df,"Arvenses", "Riesgo_relativo")
herbivoros<-genera_db(df,"Herbívoros", "Riesgo_relativo")

png("barras_riesgo.png", height=11, width=8, units="in", res=300)
par(cex=2,mfrow=c(3,1))
barplot(herbivoros, ylim=c(0,0.7), beside=T, col=c("light green", "dark green", "yellow", "red", "violet"), border="purple", ylab="\nRiesgo relativo",main="a) Riesgo relativo individual y conjunto ante la influencia de los herbívoros",xaxt="n", legend.text=T)
